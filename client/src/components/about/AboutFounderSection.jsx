      ...
      <div className="container">
        ...
        <div className="about-founder-block interactive-card">
          <aside className="about-founder-profile">
            ...
            <div className="about-founder-linkedin-badge" style={{ marginTop: '1.5rem', width: '100%', overflow: 'hidden', display: 'flex', justifyContent: 'center' }}>
              {/* Scaled wrapper to fit the 300px badge inside the smaller sidebar */}
              <div style={{ transform: 'scale(0.55)', transformOrigin: 'top center', height: '110px', width: '320px', display: 'flex', justifyContent: 'center' }}>
                <div 
